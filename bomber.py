...
def do_zip_update():
    ...
    if DEBUG_MODE:
        ...
        zip_url = "https://github.com/jj-col/TBomb/archive/dev.zip"

        dir_name = "TBomb-dev"

    else:

        zip_url = "https://github.com/jj-col/TBomb/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            ...
            "Grab The Latest one From https://github.com/jj-col/TBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            ...
            "git pull https://github.com/jj-col/TBomb.git HEAD")
...
def check_for_updates():
    ...
    fver = requests.get(
        ...
        "https://raw.githubusercontent.com/jj-col/TBomb/master/.versioncol/TBomb/master/.version"
...
def notifyen():
    ...
    try:
        ...
        if DEBUG_MODE:
            ...
            url = "https://github.com/jj-col/TBomb/raw/dev/.notify"

        else:

            url = "https://github.com/jj-col/TBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by Om")
